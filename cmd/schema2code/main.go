...
func main() {
	...
	var port int
	var mp bool
	flag.StringVar(&dbType, "type", "mysql", "数据库类型: mysql/postgres/kingbase/sqlite/tidb/tdsql/polardb/opengauss/gaussdb/highgo/vastbase/oceanbase/oceanbase-oracle/dameng/gbase8s/mssql/oracle/db2/clickhouse")
